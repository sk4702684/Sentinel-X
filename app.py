...
# --- 1. UI Configuration & Cyber Styling ---
...
# --- 3. Authentication Screen (Sign In / Sign Up) ---
...
# --- 4. Operational Dashboard (All Tools Re-Added) ---
else:
